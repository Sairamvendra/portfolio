...
const ModelInner = ({
  ...
  useLayoutEffect(() => {
    ...
    // the offset must be scaled with the group, or models not authored at the
    // origin (e.g. a Blender scene) land far outside the camera frustum
    ...
    pivotW.current.set(0, 0, 0); // model centre sits at the origin after the scaled offset above
